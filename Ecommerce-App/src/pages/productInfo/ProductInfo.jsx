                            ...
                            <div className="lg:pl-20">
                                <div className="mb-6 ">
                                    <h2 className="max-w-xl mb-6 text-xl font-semibold leading-loose tracking-wide text-gray-700 md:text-2xl dark:text-gray-300">
                                        Men Regular Fit Checkegreen Spread Collar Casual Shirt
                                    </h2>
                                ...
                                <div className="flex flex-wrap items-center mb-6">
                                    <button
                                        className="w-full px-4 py-3 text-center text-white bg-green-600 border hover:bg-green-300 hover:text-gray-800  hover:border-green-600 rounded-xl"
                                    >Add to cart
                                    </button>
                                </div>
                            </div>
